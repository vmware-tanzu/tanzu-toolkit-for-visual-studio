...
namespace Tanzu.Toolkit.ViewModels.Tests
{
    ...
    public class DeploymentDialogViewModelTests : ViewModelTestSupport
    {
        ...
        public void TestInit()
        {
            ...
            var fakeConnection = new FakeCfInstanceViewModel(_fakeCfInstance, Services);
            ...
            MockTanzuExplorerViewModel.SetupGet(m => m.CloudFoundryConnection).Returns(fakeConnection);
            ...
            MockViewLocatorService.Setup(m => m.GetViewByViewModelNameAsync(nameof(OutputViewModel), It.IsAny<string>())).ReturnsAsync(_fakeOutputView);
        ...
        [DataRow("junk name")]
        [DataRow("asdf")]
        public void Constructor_SetsTargetNameToConnectionDisplayText_WhenConnectionIsNotNull(string connectionName)
        {
            var fakeCf = new CloudFoundryInstance(connectionName, _fakeCfApiAddress);
            var fakeConnection = new FakeCfInstanceViewModel(fakeCf, Services);
            MockTanzuExplorerViewModel.SetupGet(m => m.CloudFoundryConnection).Returns(fakeConnection);
            ...
            Assert.AreEqual(connectionName, fakeConnection.DisplayText);

            Assert.IsNotNull(_sut.TargetName);
            Assert.AreEqual(fakeConnection.DisplayText, _sut.TargetName);
        }

        [TestMethod]
        [TestCategory("ctor")]
        public void Constructor_SetsIsLoggedInToTrue_WhenConnectionIsNotNull()
        {
        ...
        [TestMethod]
        [TestCategory("ctor")]
        public void Constructor_SetsTargetNameToNull_WhenConnectionIsNull()
        {
            ...
            // sanity check
            Assert.IsNull(_sut._tanzuExplorerViewModel.CloudFoundryConnection);
            Assert.IsNull(_sut.TargetName);
        }

        [TestMethod]
        [TestCategory("ctor")]
        public void Constructor_UpdatesCfOrgOptions_WhenConnectionIsNotNull()
        {
            MockTanzuExplorerViewModel.SetupGet(m => m.CloudFoundryConnection).Returns(new FakeCfInstanceViewModel(_fakeCfInstance, Services));
        ...
        [TestCategory("ctor")]
        [TestCategory("BuildpackOptions")]
        public void Constructor_UpdatesBuildpackOptions_WhenConnectionIsNotNull()
        {
            MockTanzuExplorerViewModel.SetupGet(m => m.CloudFoundryConnection).Returns(new FakeCfInstanceViewModel(_fakeCfInstance, Services));
        ...
        [TestCategory("ctor")]
        [TestCategory("ServiceOptions")]
        public void Constructor_UpdatesServiceOptions_WhenConnectionIsNotNull()
        {
            MockTanzuExplorerViewModel.SetupGet(m => m.CloudFoundryConnection).Returns(new FakeCfInstanceViewModel(_fakeCfInstance, Services));
        ...
        [TestCategory("ctor")]
        [TestCategory("StackOptions")]
        public void Constructor_UpdatesStackOptions_WhenConnectionIsNotNull()
        {
            MockTanzuExplorerViewModel.SetupGet(m => m.CloudFoundryConnection).Returns(new FakeCfInstanceViewModel(_fakeCfInstance, Services));
        ...
        public void Constructor_SetsOnCloseAction_ToCloseDeploymentDialog()
        {
            ...
            MockDialogService.Verify(m => m.CloseDialogByNameAsync(nameof(DeploymentDialogViewModel), It.IsAny<object>()), Times.Once);
        }
        ...
        public void DeployApp_SetsDeploymentInProgress_AndInvokesStartDeployment_AndClosesDeploymentDialog_WhenCanDeployAppIsTrue()
        {
            ...
            MockThreadingService.Verify(mock => mock.StartBackgroundTaskAsync(_sut.StartDeploymentAsync), Times.Once);
        }
        ...
        public void DeployApp_DoesNothing_WhenCanDeployAppIsFalse()
        {
            ...
            MockThreadingService.Verify(mock => mock.StartBackgroundTaskAsync(_sut.StartDeploymentAsync), Times.Never);
        }

        [TestMethod]
        [TestCategory("StartDeploymentAsync")]
        public async Task StartDeploymentTask_UpdatesDeploymentInProgress_WhenComplete()
        {
            ...
            var expectedStdOutCallback = _sut._outputViewModel.AppendLine;
            var expectedStdErrCallback = _sut._outputViewModel.AppendLine;

            MockCloudFoundryService.Setup(mock =>
                    mock.DeployAppAsync(expectedManifest, expectedDefaultAppPath, expectedCf, expectedOrg, expectedSpace, expectedStdOutCallback, expectedStdErrCallback))
            ...
            await _sut.StartDeploymentAsync();
        ...
        public async Task StartDeploymentTask_LogsError_WhenDeployResultReportsFailure()
        {
            ...
            MockErrorDialogService.Setup(mock => mock.DisplayErrorDialog(expectedErrorTitle, expectedErrorMsg));
            ...
            var expectedLogMsg =
                $"DeploymentDialogViewModel initiated app deployment of {logPropVal1} to target {logPropVal2}.{logPropVal3}.{logPropVal4}; deployment result reported failure: {logPropVal5}.";

            MockLogger.Verify(m => m.Error(expectedLogMsg, _fakeAppName, _fakeCfInstance.ApiAddress, _fakeOrg.OrgName, _fakeSpace.SpaceName, _fakeFailureDetailedResult.ToString()),
                Times.Once);
        }
        ...
        {
            var invalidRefreshTokenFailure = new DetailedResult(false, "junk error", _fakeFailureCmdResult) { FailureType = FailureType.InvalidRefreshToken };
        ...
        public async Task StartDeployment_TrimsRedundantInfoFromErrorMessage()
        {
            ...
            MockErrorDialogService.Verify(m => m.DisplayErrorDialog(
        ...
        {
            var fakeCf = new CloudFoundryInstance("junk name", _fakeCfApiAddress);
            var fakeConnection = new FakeCfInstanceViewModel(fakeCf, Services);
            MockTanzuExplorerViewModel.SetupGet(m => m.CloudFoundryConnection).Returns(fakeConnection);
            ...
            MockCloudFoundryService.Setup(mock => mock.GetOrgsForCfInstanceAsync(fakeCf, false, It.IsAny<int>()))
        ...
        [TestMethod]
        public async Task UpdateCfOrgOptions_SetsCfOrgOptionsToEmptyList_WhenConnectionIsNull()
        {
            MockTanzuExplorerViewModel.SetupGet(m => m.CloudFoundryConnection).Returns((CfInstanceViewModel)null);
        ...
        {
            var fakeCf = new CloudFoundryInstance("fake junk name", _fakeCfApiAddress);
            var fakeConnection = new FakeCfInstanceViewModel(fakeCf, Services);
            MockTanzuExplorerViewModel.SetupGet(m => m.CloudFoundryConnection).Returns(fakeConnection);
            ...
            MockErrorDialogService.Setup(mock => mock.DisplayErrorDialog(DeploymentDialogViewModel._getOrgsFailureMsg, fakeExplanation));
        ...
        public async Task UpdateCfOrgOptions_LogsError_WhenOrgsResponseReportsFailure()
        {
            ...
            MockLogger.Verify(m => m.Error($"{DeploymentDialogViewModel._getOrgsFailureMsg}. {fakeFailedOrgsResponse}"),
                Times.Once);
        }
        ...
        public async Task UpdateCfSpaceOptions_RaisesPropertyChangedEvent_WhenSpacesRequestSucceeds()
        {
            ...
            MockCloudFoundryService.Setup(mock => mock.GetSpacesForOrgAsync(_fakeCfOrg, false, It.IsAny<int>()))
        ...
        public async Task UpdateCfSpaceOptions_LogsError_WhenSpacesResponseReportsFailure()
        {
            ...
            MockErrorDialogService.Setup(mock => mock.DisplayErrorDialog(DeploymentDialogViewModel._getSpacesFailureMsg, fakeExplanation));

            _sut.SelectedOrg = _fakeCfOrg;

            await _sut.UpdateCfSpaceOptionsAsync();

            MockLogger.Verify(m => m.Error($"{DeploymentDialogViewModel._getSpacesFailureMsg}. {fakeFailedSpacesResponse}"),
                Times.Once);
        }
        ...
        public async Task OpenLoginView_InvokesOpenLoginViewOnTanzuExplorerViewModelAsync()
        {
            var fakeArg = new object();

            await _sut.OpenLoginViewAsync(fakeArg);

            MockTanzuExplorerViewModel.Verify(m => m.OpenLoginViewAsync(fakeArg), Times.Once);
        }

        [TestMethod]
        [TestCategory("OpenLoginViewAsync")]
        public async Task OpenLoginView_SetsCfInstanceOptions_WhenConnectionGetsSet()
        {
            var fakeArg = new object();

            MockTanzuExplorerViewModel.Setup(m => m.OpenLoginViewAsync(fakeArg))
                .Callback(() =>
                {
        ...
        [TestMethod]
        [TestCategory("OpenLoginViewAsync")]
        public async Task OpenLoginView_DoesNotChangeCfInstanceOptions_WhenConnectionDoesNotGetSet()
        {
            var fakeArg = new object();
        ...
        [TestMethod]
        [TestCategory("OpenLoginViewAsync")]
        public async Task OpenLoginView_SetsIsLoggedInPropertyToTrue_WhenConnectionGetsSet()
        {
            MockTanzuExplorerViewModel.SetupGet(m => m.CloudFoundryConnection).Returns((CfInstanceViewModel)null);
            MockTanzuExplorerViewModel.Setup(m => m.OpenLoginViewAsync(null))
                .Callback(() =>
                {
                    MockTanzuExplorerViewModel.SetupGet(m => m.CloudFoundryConnection)
                        .Returns(new CfInstanceViewModel(_fakeCfInstance, null, Services));
        ...
        [TestMethod]
        [TestCategory("OpenLoginViewAsync")]
        public async Task OpenLoginView_SetsTargetName_WhenConnectionIsNotNull()
        {
            MockTanzuExplorerViewModel.SetupGet(m => m.CloudFoundryConnection).Returns((CfInstanceViewModel)null);
            MockTanzuExplorerViewModel.Setup(m => m.OpenLoginViewAsync(null))
                .Callback(() =>
            ...
            Assert.AreEqual(_sut._tanzuExplorerViewModel.CloudFoundryConnection.DisplayText, _sut.TargetName);
        }

        [TestMethod]
        [TestCategory("OpenLoginViewAsync")]
        public async Task OpenLoginView_UpdatesCfOrgOptions_WhenConnectionGetsSet()
        {
            MockTanzuExplorerViewModel.SetupGet(m => m.CloudFoundryConnection).Returns((CfInstanceViewModel)null);
            MockTanzuExplorerViewModel.Setup(m => m.OpenLoginViewAsync(null))
                .Callback(() =>
        ...
        [TestCategory("OpenLoginViewAsync")]
        [TestCategory("BuildpackOptions")]
        public async Task OpenLoginView_UpdatesBuildpackOptions_WhenConnectionGetsSet()
        {
            MockTanzuExplorerViewModel.SetupGet(m => m.CloudFoundryConnection).Returns((CfInstanceViewModel)null);
            MockTanzuExplorerViewModel.Setup(m => m.OpenLoginViewAsync(null))
                .Callback(() =>
        ...
        [TestCategory("OpenLoginViewAsync")]
        [TestCategory("ServiceOptions")]
        public async Task OpenLoginView_UpdatesServiceOptions_WhenConnectionGetsSet()
        {
            MockTanzuExplorerViewModel.SetupGet(m => m.CloudFoundryConnection).Returns((CfInstanceViewModel)null);
            MockTanzuExplorerViewModel.Setup(m => m.OpenLoginViewAsync(null))
                .Callback(() =>
        ...
        [TestCategory("OpenLoginViewAsync")]
        [TestCategory("StackOptions")]
        public async Task OpenLoginView_UpdatesStackOptions_WhenConnectionGetsSet()
        {
            MockTanzuExplorerViewModel.SetupGet(m => m.CloudFoundryConnection).Returns((CfInstanceViewModel)null);
            MockTanzuExplorerViewModel.Setup(m => m.OpenLoginViewAsync(null))
                .Callback(() =>
        ...
        public void IsLoggedIn_ReturnsTrue_WhenConnectionIsNotNull()
        {
            MockTanzuExplorerViewModel.SetupGet(m => m.CloudFoundryConnection).Returns(new FakeCfInstanceViewModel(_fakeCfInstance, Services));
        ...
        [TestMethod]
        [TestCategory("IsLoggedIn")]
        public void IsLoggedIn_ReturnsFalse_WhenConnectionIsNull()
        {
            MockTanzuExplorerViewModel.SetupGet(m => m.CloudFoundryConnection).Returns((CfInstanceViewModel)null);
        ...
        public void ManifestPathSetter_DisplaysError_AndDoesNotChangeAppName_WhenManifestDoesNotExist()
        {
            ...
            MockErrorDialogService.Setup(m => m.DisplayWarningDialog(DeploymentDialogViewModel._manifestNotFoundTitle,
                    It.Is<string>(s => s.Contains(pathToNonexistentManifest) && s.Contains("does not appear to be a valid path to a manifest"))))
                .Verifiable();
        ...
        public void ManifestPathSetter_DoesNotChangeSelectedBuildpacks_AndDisplaysError_WhenManifestDoesNotExist()
        {
            ...
            MockErrorDialogService.Verify(
                m => m.DisplayWarningDialog(DeploymentDialogViewModel._manifestNotFoundTitle,
                    It.Is<string>(s => s.Contains(pathToNonexistentManifest) && s.Contains("does not appear to be a valid path to a manifest"))), Times.Once);
        }
        ...
        public void DirectoryPathSetter_DisplaysError_AndSetsDirectoryPathLabelToDefaultAppDirectory_AndSetsManifestModelPathValueToNull_WhenNoDirectoryExistsAtGivenPath()
        {
            ...
            MockErrorDialogService.Verify(
                m => m.DisplayWarningDialog(DeploymentDialogViewModel._directoryNotFoundTitle,
                    It.Is<string>(s => s.Contains(fakePath) && s.Contains("does not appear to be a valid path"))),
                Times.Once);
        }
        ...
        [TestMethod]
        [TestCategory("UpdateBuildpackOptionsAsync")]
        public async Task UpdateBuildpackOptions_SetsBuildpackOptionsToEmptyList_WhenNotLoggedIn()
        {
            ...
            await _sut.UpdateBuildpackOptionsAsync();
        ...
        {
            var fakeCf = new FakeCfInstanceViewModel(_fakeCfInstance, Services);
            ...
            var fakeBuildpacksResponse = new DetailedResult<List<CfBuildpack>> { Succeeded = true, Content = fakeBuildpacksContent };
        ...
        [TestMethod]
        [TestCategory("UpdateServiceOptionsAsync")]
        public async Task UpdateServiceOptions_SetsServiceOptionsToEmptyList_WhenNotLoggedIn()
        {
            ...
            await _sut.UpdateServiceOptionsAsync();
        ...
        public async Task UpdateServiceOptions_SetsServiceOptionsToQueryContent_WhenQuerySucceeds()
        {
            ...
            var fakeServicesResponse = new DetailedResult<List<CfService>> { Succeeded = true, Content = fakeServicesContent };
        ...
        [TestMethod]
        [TestCategory("UpdateStackOptionsAsync")]
        public async Task UpdateStackOptions_SetsStackOptionsToEmptyList_WhenNotLoggedIn()
        {
            ...
            await _sut.UpdateStackOptionsAsync();
        ...
        public void WriteManifestToFile_DisplaysErrorDialog_AndLogsError_WhenFileCreationFails()
        {
            ...
            MockErrorDialogService.Verify(m => m.DisplayErrorDialog("Unable to save manifest file", It.Is<string>(s => s.Contains(fakeExceptionMsg) && s.Contains(fakeFilePath))),
                Times.Once);
        }
    }
    ...
    public class FakeBuildpackListItem : BuildpackListItem
    {
        public FakeBuildpackListItem(string name, bool selected, bool compatibleWithCurrentStack, List<string> stacks)
        {
            ...
            if (compatibleWithCurrentStack)
            {
                ...
                EvaluateStackCompatibility(null);
            }
            else
            {
                // set CompatibleWithStack to false
                EvaluateStackCompatibility("some junk that should purposefully not appear in list of stacks");
            }
        }
    }
}