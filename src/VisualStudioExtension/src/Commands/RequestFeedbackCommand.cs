...
namespace Tanzu.Toolkit.VisualStudio
{
    ...
    internal sealed class RequestFeedbackCommand
    {
        ...
        private RequestFeedbackCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new RequestFeedbackCommand(package, commandService);
        }
        ...
        {
            string mailto = string.Format("mailto:{0}?Subject={1}", "tas-vs-extension@vmware.com", "Subject of message");
