    ...
    public class CfCliServiceTests : CfCliServiceTestSupport
    {
        ...
        public async Task RunCfCommandAsync_ReturnsSuccessfulResult_WhenCmdProcessExitsWithZeroCode()
        {
            _mockCmdProcessService.Setup(mock => mock.
              RunCommand(_fakePathToCfExe, _fakeArguments, null, _fakeOutCallback, _fakeErrCallback, _defaultEnvVars))
        ...
        public async Task RunCfCommandAsync_UsesDefaultDir_WhenNotSpecified()
        {
            ...
            _mockCmdProcessService.Setup(mock => mock.
                RunCommand(_fakePathToCfExe, _fakeArguments, expectedWorkingDir, It.IsAny<StdOutDelegate>(), It.IsAny<StdErrDelegate>(), _defaultEnvVars))
                    .Returns(_fakeSuccessResult);

            DetailedResult result = await _sut.RunCfCommandAsync(_fakeArguments);

            _mockCmdProcessService.Verify(mock => mock.RunCommand(_fakePathToCfExe, _fakeArguments, expectedWorkingDir, null, null, _defaultEnvVars), Times.Once());
        }
        ...
        public async Task RunCfCommandAsync_SetsCFHOMEEnvironmentVariable_ToConfigFilePath()
        {
            ...
            _mockCmdProcessService.Setup(mock => mock.
                RunCommand(_fakePathToCfExe, _fakeArguments, expectedWorkingDir, It.IsAny<StdOutDelegate>(), It.IsAny<StdErrDelegate>(), expectedEnvVars))
                    .Returns(_fakeSuccessResult);

            DetailedResult result = await sut.RunCfCommandAsync(_fakeArguments);

            _mockCmdProcessService.Verify(mock => mock.RunCommand(_fakePathToCfExe, _fakeArguments, expectedWorkingDir, null, null, expectedEnvVars), Times.Once());
        }
        ...
        {
            _mockCmdProcessService.Setup(mock => mock.
              RunCommand(_fakePathToCfExe, _fakeArguments, null, null, null, _defaultEnvVars))
                .Returns(_fakeSuccessResult);
        ...
        {
            _mockCmdProcessService.Setup(mock => mock.
              RunCommand(_fakePathToCfExe, CfCliService._getOAuthTokenCmd, null, null, null, _defaultEnvVars))
        ...
        public void GetOAuthToken_CachesFirstTokenResult()
        {
            ...
            _mockCmdProcessService.Setup(m => m.
              RunCommand(_fakePathToCfExe, It.Is<string>(s => s.Contains(CfCliService._getOAuthTokenCmd)), null, null, null, _defaultEnvVars))
        ...
        public void TargetApi_ReturnsTrue_WhenCmdExitCodeIsZero()
        {
            ...
            _mockCmdProcessService.Setup(mock => mock.
              RunCommand(_fakePathToCfExe, expectedArgs, null, null, null, _defaultEnvVars))
                .Returns(new CmdResult(_fakeStdOut, _fakeStdErr, 0));
        ...
        public async Task GetOrgsAsync_ReturnsFailedResult_For401UnauthorizedResponse()
        {
            ...
            _mockCmdProcessService.Setup(mock => mock.
              RunCommand(_fakeProjectPath, expectedArgs, null, null, null, _defaultEnvVars))
                .Returns(fakeFailureCmdResult);
        ...
        public async Task StartAppByNameAsync_ReturnsTrueResult_WhenCmdExitCodeIsZero()
        {
            ...
            _mockCmdProcessService.Setup(mock => mock.
              RunCommand(_fakePathToCfExe, expectedCmdStr, null, null, null, _defaultEnvVars))
                .Returns(fakeSuccessResult);
        ...
        public async Task PushAppAsync_ReturnsSuccessResult_WhenCommandSucceeds()
        {
            ...
            _mockCmdProcessService.Setup(m => m.
              RunCommand(_fakePathToCfExe, expectedTargetOrgCmdArgs, null, null, null, _defaultEnvVars))
                .Returns(_fakeSuccessCmdResult);

            _mockCmdProcessService.Setup(m => m.
              RunCommand(_fakePathToCfExe, expectedTargetSpaceCmdArgs, null, null, null, _defaultEnvVars))
                .Returns(_fakeSuccessCmdResult);

            _mockCmdProcessService.Setup(m => m.
                RunCommand(_fakePathToCfExe, expectedArgs, _fakeProjectPath, null, null, _defaultEnvVars))
                    .Returns(_fakeSuccessCmdResult);
        ...
        public async Task GetRecentAppLogs_ReturnsSuccessResult_WhenLogsCmdSucceeds()
        {
            ...
            _mockCmdProcessService.Setup(m => m.
                RunCommand(_fakePathToCfExe, expectedLogsCmdArgs, null, null, null, _defaultEnvVars))
                    .Returns(mockCmdResult);
