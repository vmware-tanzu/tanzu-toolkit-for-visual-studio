...
namespace Tanzu.Toolkit.VisualStudio.Commands
{
    ...
    internal sealed class OutputWindowCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("a236e835-5509-4066-a3a2-cf1661b8b22e");
        ...
        /// </summary>
        public static OutputWindowCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            // Switch to the main thread - the call to AddCommand in OutputWindowCommand's constructor requires
            // the UI thread.
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync(package.DisposalToken);

            OleMenuCommandService commandService = await package.GetServiceAsync(typeof(IMenuCommandService)) as OleMenuCommandService;
            Instance = new OutputWindowCommand(package, commandService);
        }
